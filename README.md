...
An open-source alternative to [Granola](https://www.granola.ai). akou transcribes your calls on your own machine, answers questions about them with the Claude Code or Codex subscription you already pay for, and saves the notes into the tools you use today. It runs on macOS, Windows and Linux, and as a [transcription server](docs/ux/SERVER.md) you host yourself.
